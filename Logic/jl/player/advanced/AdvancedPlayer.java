...
package Logic.jl.player.advanced;

import java.io.InputStream;

import Logic.jl.decoder.Bitstream;
import Logic.jl.decoder.BitstreamException;
import Logic.jl.decoder.Decoder;
import Logic.jl.decoder.Header;
import Logic.jl.decoder.JavaLayerException;
import Logic.jl.decoder.SampleBuffer;
import Logic.jl.player.AudioDevice;
import Logic.jl.player.FactoryRegistry;

/**
 * a hybrid of Logic.jl.player.Player tweeked to include <code>play(startFrame, endFrame)</code>
